...
export const H1: FunctionComponent<HeadingProps> = ({ children }) => {
  return (
    <h1 className="font-comic mt-0 mb-8 text-5xl font-extrabold">{children}</h1>
  );
};

export const H2: FunctionComponent<HeadingProps> = ({ children }) => {
  return <h2 className="font-comic mb-6 text-3xl font-bold">{children}</h2>;
};

export const H3: FunctionComponent<HeadingProps> = ({ children }) => {
  return <h3 className="font-comic mb-3 text-2xl font-semibold">{children}</h3>;
};
